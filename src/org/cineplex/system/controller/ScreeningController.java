...
public class ScreeningController {
    ...
    // ✅ CORRECCIÓN CLAVE: Usar lambdas en lugar de PropertyValueFactory
    // porque Screening NO tiene métodos *Property()
    private void configurarTabla() {
        colSala.setCellValueFactory(data -> 
            new javafx.beans.property.SimpleStringProperty(
                data.getValue().getAuditoriumName() != null ? data.getValue().getAuditoriumName() : ""));
        
        colPelicula.setCellValueFactory(data -> 
            new javafx.beans.property.SimpleStringProperty(
                data.getValue().getMovieTitle() != null ? data.getValue().getMovieTitle() : ""));
    ...
    private void cargarSalas() {
        try {
            ...
            alertInfo.viewAlert("ERROR", "Error de carga", "No se pudieron cargar las salas", e.getMessage());
        }
    }
    ...
    private void programarFuncion() {
        ...
        try {
            ...
            Screening screening = new Screening(movie.getMovieId(), auditorium.getAuditoriumId(), showDate, showTime);
            screeningService.createScreening(screening);
            
            alertInfo.viewAlert("INFORMATION", "Éxito", "Función programada", 
            ...
            alertInfo.viewAlert("ERROR", "Error de programación", "Conflicto de horario", e.getMessage());
        }
    }
    ...
    private void regresarMenu() {
        try {
            ...
            e.printStackTrace();
            alertInfo.viewAlert("ERROR", "Error de navegación", "No se pudo cargar la vista", "Detalle: " + e.getMessage());
        }
    }

...
public class MovieRegisterController {
    ...
    /**
     * NUEVO MÉTODO: Abre la URL del póster en el navegador del sistema
     */
    @FXML
    private void verPoster() {
        String url = txtPoster.getText().trim();
        
        // Si el campo está vacío, intenta obtener la URL de la película seleccionada en la tabla
        if (url.isEmpty()) {
        ...
        try {
            // Abre la URL en el navegador predeterminado (Chrome, Edge, etc.)

...
import org.cineplex.system.dao.UsuarioDAO;
...
public class AuthService {
    ...
    public ResultadoLogin login(String nombreUsuario, String passwordPlano, String rolEsperado) {
        ...
        if (!usuario.getRol().getNombreRol().equalsIgnoreCase(rolEsperado)) {
            return new ResultadoLogin(false, "Este usuario no tiene permisos de " + rolEsperado + ".", null);
        }
